...
public class ExecuteIB_ML20M_3
{
	public static void main(String[] args)
	{
		
		Object[] metrics = {new CosineMetric(), new PearsonMetric(), 
				new PearsonSigWeightingMetric(50), new MeanSquaredDifferenceMetric()};
		String[] m_names = {"CosineMetric", "PearsonMetric",
				"PearsonSigWeightingMetric", "MeanSquaredDifferenceMetric"};
		for (int i = 0; i < metrics.length; i++)
		{
			System.out.println(m_names[i] + "is running");
			...
			SimilarityMetric metric = (SimilarityMetric) metrics[i];
			...
			// - the RMSE (if actual ratings are available) and coverage are output to
			//////////////////////////////////////////////// screen
